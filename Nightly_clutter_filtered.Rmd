---
title: "Nigthly clutter filtered"
author: "M. Bradaric"
date: "2/12/2021"
output:
  html_document:
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
birds_n1 <- subset(vert,night=='2019-10-02 - 2019-10-03')
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
birds_n6 <- subset(vert,night=='2019-10-20 - 2019-10-21')
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
birds_n7 <- subset(vert,night=='2019-10-28 - 2019-10-29')
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
vert1 <- read.csv("C:/Users/mbradar/Documents/Robin/data/Birds/Luchterduinen/allseasons_2019-2020_vert&mixed.csv",sep=";")
vert1$timestamph <- as.POSIXct(vert1$timestamph,tz='UTC')
vert1 <- subset(vert1,datex>='2020-09-30 17:00:00' & datex<='2020-11-01 07:00:00')
vert1$timestamp <- as.POSIXct(vert1$timestamp,tz='UTC')
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
birds_n8 <- subset(vert1,night=='2020-10-05 - 2020-10-06')
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
birds_n9 <- subset(vert1,night=='2020-10-06 - 2020-10-07')
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
birds_n10 <- subset(vert1,night=='2020-10-15 - 2020-10-16')
...
```{r,message=FALSE,echo=FALSE,warning=FALSE,fig.height=10,out.width = '110%'}
birds_n11 <- subset(vert1,night=='2020-10-16 - 2020-10-17')
